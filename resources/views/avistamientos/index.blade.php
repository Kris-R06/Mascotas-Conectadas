                        ...
                        <div class="p-5 flex flex-col flex-grow">
                            ...
                            <div class="mt-auto pt-4 border-t border-slate-50 flex items-center gap-2">
                                @if($reporte->user_id == auth()->id())
                                    <a href="{{ route('avistamientos.edit', $reporte->id) }}" class="w-full flex justify-center items-center gap-2 bg-blue-50 hover:bg-blue-500 hover:text-white text-blue-700 font-bold py-2.5 px-4 rounded-xl transition-colors text-sm">
